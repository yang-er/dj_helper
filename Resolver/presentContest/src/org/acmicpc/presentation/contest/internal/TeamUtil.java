...
import org.acmicpc.contest.model.IContest;
import org.acmicpc.contest.model.IOrganization;
import org.acmicpc.contest.model.ITeam;
...
public class TeamUtil
{
    ...
    private static final String[] STYLE_STR = { "team_name", "org_name", "org_formal_name", "team_and_org_name" };
    ...
    public static String getTeamName(Style style, IContest contest, ITeam team)
    {
        ...
        if (style2 == Style.TEAM_AND_ORG_NAME) {
            s = s + " (" + org.getFormalName() + ")";
            // modified: from getName() to getFormalName()
